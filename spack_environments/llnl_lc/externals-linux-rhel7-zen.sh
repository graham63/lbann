...
EXTERNAL_ALL_PACKAGES=$(cat <<EOF
    all:
      providers:
        mpi:
          - mvapich2@2.3 arch=linux-rhel7-zen
        lapack:
...
EXTERNAL_PACKAGES=$(cat <<EOF
    cmake::
      ...
      - 3.18.0
      externals:
      - spec: cmake@3.18.0 arch=linux-rhel7-zen
        modules:
        -  cmake/3.18.0
    gcc::
      buildable: False
      ...
      - 7.3.0
      externals:
      - spec: gcc@7.3.0 arch=linux-rhel7-zen
        modules:
        - gcc/7.3.0
    hwloc::
      buildable: False
      ...
      - 2.0.2
      externals:
      - spec: hwloc@2.0.2 arch=linux-rhel7-zen
    ...
    mvapich2::
      ...
      - 2.3
      externals:
      - spec: mvapich2@2.3%gcc@7.3.0 arch=linux-rhel7-zen
    ...
    python::
      ...
      - 3.7.2
      externals:
      - spec: python@3.7.2 arch=linux-rhel7-zen
        modules:
        - python/3.7.2
    rdma-core::
      buildable: False
      ...
      - 20
      externals:
      - spec: rdma-core@20 arch=linux-rhel7-zen
        prefix: /usr
EOF
)
