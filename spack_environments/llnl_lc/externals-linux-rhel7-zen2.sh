...
EXTERNAL_ALL_PACKAGES=$(cat <<EOF
    all:
      providers:
        mpi:
          - mvapich2@2.3 arch=linux-rhel7-zen2
        lapack:
...
EXTERNAL_PACKAGES=$(cat <<EOF
    cmake::
      ...
      - 3.18.0
      externals:
      - spec: cmake@3.18.0 arch=linux-rhel7-zen2
        modules:
        -  cmake/3.18.0
    cuda::
      buildable: False
      ...
      - 10.2.89
      externals:
      - spec: cuda@10.2.89 arch=linux-rhel7-zen2
        modules:
        - cuda/10.2.89
    cudnn::
      buildable: true
    ...
    gcc::
      ...
      - 7.3.0
      externals:
      - spec: gcc@7.3.0 arch=linux-rhel7-zen2
        modules:
        - gcc/7.3.0
    hwloc::
      buildable: False
      ...
      - 2.0.2
      externals:
      - spec: hwloc@2.0.2 arch=linux-rhel7-zen2
    ...
    mvapich2::
      ...
      - 2.3
      externals:
      - spec: mvapich2@2.3%gcc@7.3.0 arch=linux-rhel7-zen2
    ...
    python::
      ...
      - 3.7.2
      externals:
      - spec: python@3.7.2 arch=linux-rhel7-zen2
        modules:
        - python/3.7.2
    rdma-core::
      buildable: False
      ...
      - 20
      externals:
      - spec: rdma-core@20 arch=linux-rhel7-zen2
        prefix: /usr
EOF
)
