...
#
# FIXME: Is this right?
# discriminator_model.py - Two models training simultaneously to learn to
# recognize a computer generated image.
#
################################################################################
...
sys.path.insert(0, os.path.join(os.path.dirname(os.path.dirname(current_dir)), 'data'))
import gan

# Command-line arguments
desc = ('Construct and run gan with mnist.'
        'Running the experiment is only supported on LC systems.')
parser = argparse.ArgumentParser(description=desc)
lbann.contrib.args.add_scheduler_arguments(parser)
parser.add_argument(
    '--job-name', action='store', default='lbann_GAN', type=str,
